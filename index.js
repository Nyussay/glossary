...
downloadDictionary('https://raw.githubusercontent.com/nyussay/glossary/master/glossary.json', 'glossary.json', (err) => {
    if (err) {
        console.log(err);
        return;
    }
    loadDictionary('glossary.json', (err) => {
        if (err) {
            console.log(err);
            return;
        }
